...
class CourseView(generic.DetailView):
    ...
    def dispatch(self, request, pk, *args, **kwargs):
        ...
        if request.user.is_authenticated and self.request.user.has_perm('app_lessons.course.view'):
    ...
    def get_context_data(self, **kwargs):
        ...
        if self.request.user.is_authenticated and self.request.user.has_perm('app_lessons.lesson.view'):
...
class LessonView(generic.DetailView):
    ...
    def dispatch(self, request, pk, *args, **kwargs):
        ...
        if request.user.is_authenticated and self.request.user.has_perm('app_lessons.lesson.view'):
